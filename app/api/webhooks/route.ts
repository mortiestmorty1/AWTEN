      ...
      switch (event.type) {
        ...
        case 'checkout.session.completed':
          ...
          if (checkoutSession.mode === 'subscription') {
            ...
            if (checkoutSession.metadata?.type === 'premium_subscription') {
              ...
              if (userId && planId && subscriptionId) {
                ...
                console.error('Missing required data for premium upgrade:', {
                  userId,
                  planId,
                  subscriptionId
                });
          ...
          if (
            ...
            checkoutSession.metadata?.type === 'credit_purchase'
          ) {
            const userId = checkoutSession.metadata.user_id;
            ...
            if (
              ...
              await processCreditPurchase(userId, credits, checkoutSession.id);
            }
          }
          break;
        default:
